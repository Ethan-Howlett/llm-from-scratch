...
if __name__ == "__main__":
    ...
    parser.add_argument('--model_size', default='gpt2-medium (355M)', choices=['gpt2-small (124M)', 'gpt2-medium (355M)', 'gpt2-large (774M)', 'gpt2-xl (1558M)'])
    parser.add_argument('--batch_size', type=int, default=8)
    parser.add_argument('--epochs', type=int, default=5)
    parser.add_argument('--lr', type=float, default=5e-5)
    parser.add_argument('--weight_decay', type=float, default=0.1)
    parser.add_argument('--balance_dataset', type=int, default=1)
    ...
    train_dataset = SupportDataset(
        ...
        tokenizer=tokenizer,
        max_length=None,
        balance_dataset=bool(int(args.balance_dataset))
    )

    val_dataset = SupportDataset(
        csv_file='data/support_tickets_dev.csv',
        tokenizer=tokenizer,
    ...
    test_dataset = SupportDataset(
        csv_file='data/support_tickets_test.csv',
        tokenizer=tokenizer,
        max_length=train_dataset.max_length,
        balance_dataset=False
    )
